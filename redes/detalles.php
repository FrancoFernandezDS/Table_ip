...
// Obtener datos de la red con consulta preparada
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h2 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="index.php">DETALLES DE RED</a>	
        <!-- User -->
    ...
    <div class="header pb-6 pt-5 pt-lg-6 d-flex align-items-center">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="col-lg-7 col-md-10">
          <h1 class="display-2 text-white">Detalles de Red</h1>
          <p class="text-white mt-0 mb-5">Información completa de la red seleccionada</p>
        </div>
      </div>
    </div>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Red: <?php echo htmlspecialchars($red['nombre_red']); ?></h3>
                </div>
                <div class="col-4 text-right">
                  <a href="editar.php?id=<?php echo $red['id']; ?>" class="btn btn-sm btn-warning">
            ...
            <div class="card-body">
              <div class="pl-lg-4">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label"><strong>Nombre de Equipo:</strong></label>
                      <div class="form-control-plaintext"><?php echo htmlspecialchars($red['telefono_contacto']); ?></div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-control-label"><strong>Fecha de Instalación:</strong></label>
                      <div class="form-control-plaintext"><?php echo htmlspecialchars($red['fecha_instalacion']); ?></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label class="form-control-label"><strong>Observaciones:</strong></label>
                      <div class="form-control-plaintext" style="min-height: 100px; background-color: #f8f9fa; padding: 1rem; border-radius: 0.375rem;">
                        <?php echo nl2br(htmlspecialchars($red['observaciones'])); ?>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="text-center mt-4">
                  <a href="editar.php?id=<?php echo $red['id']; ?>" class="btn btn-warning">
                    <i class="fas fa-edit"></i> Editar
                  </a>
